...
// Это неймспейс с сетевыми утилитами YT — обёртки над сокетами, парсинг/форматирование адресов (TNetworkAddress, IPv4/IPv6),
// DNS-резолвер, listener-ы. Конвенция YT: каждый поддомен кода живёт в NYT::N<Что-то> — NRpc, NConcurrency, NYTree, NTableClient и так далее.
